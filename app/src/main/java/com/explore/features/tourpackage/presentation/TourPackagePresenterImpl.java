...
public class TourPackagePrersenterImpl implements TourPackagePresenter, TourPackageIteractor.OnTourPackageFinishListener {
    @Getter
    @Setter
    ...
    public TourPackagePrersenterImpl(TourPackageView tourPackageView) {
